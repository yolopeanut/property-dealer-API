...
namespace PropertyDealer.API.Tests.Core.Logic.Integration
{
    public class EndToEndActionFlowTests : IntegrationTestBase
    {
            ...
            : base(factory)
        {
            ...
            this._pendingActionManager =
                base.ServiceProvider.GetRequiredService<IPendingActionManager>();
            this._deckManager = base.ServiceProvider.GetRequiredService<IDeckManager>();
            this._actionHandlerResolver =
                base.ServiceProvider.GetRequiredService<IActionHandlerResolver>();
            this._actionExecutionManager =
                base.ServiceProvider.GetRequiredService<IActionExecutionManager>();
        ...
        public void ExploreNewSector_EndToEnd_DrawsTwoCards()
        {
            ...
            var player = GameStateTestHelpers.SetupPlayerInGame(
                this._playerManager,
                this._playerHandManager,
                "user1",
                "Player1"
            );
            var exploreCard = CardTestHelpers.CreateCommandCard(ActionTypes.ExploreNewSector);
            GameStateTestHelpers.GivePlayerCards(
                this._playerHandManager,
                player.UserId,
                [exploreCard]
            );
            ...
            // Act
            var result = this._actionExecutionManager.ExecuteAction(
                player.UserId,
                exploreCard,
                player,
        ...
        public void TradeDividend_EndToEnd_AllPlayersPayInitiator()
        {
            // Arrange
            GameStateTestHelpers.PopulateTestDeck(this._deckManager);
            var initiator = GameStateTestHelpers.SetupPlayerInGame(
                this._playerManager,
                this._playerHandManager,
                "user1",
                "Initiator"
            );
            var target1 = GameStateTestHelpers.SetupPlayerInGame(
                this._playerManager,
                this._playerHandManager,
                "user2",
                "Target1"
            );
            var target2 = GameStateTestHelpers.SetupPlayerInGame(
                this._playerManager,
                this._playerHandManager,
                "user3",
                "Target2"
            ...
            var payResponse1 = ResponseTestHelpers.CreatePayValueResponse(
                actionContext,
                this._playerHandManager,
                target1.UserId,
                2
            ...
            var payResponse2 = ResponseTestHelpers.CreatePayValueResponse(
                actionContext,
                this._playerHandManager,
                target2.UserId,
                2
            ...
            var initiatorMoney = VerificationTestHelpers.GetPlayerMoneyTotal(
                this._playerHandManager,
                initiator.UserId
            );
        ...
        public void SystemWildCard_EndToEnd_PlacesCardWithSelectedColor()
        {
            ...
            var colorResponse = ResponseTestHelpers.CreateWildcardColorResponse(
                actionContext,
            ...
            var redProperties = this._playerHandManager.GetPropertyGroupInPlayerTableHand(
                player.UserId,
                PropertyCardColoursEnum.Red
            );
        ...
        public void SpaceStation_EndToEnd_PlacesOnPropertySet()
        {
            ...
            GameStateTestHelpers.PopulateTestDeck(this._deckManager);
            GameStateTestHelpers.GivePlayerPropertySet(
                this._playerHandManager,
                player.UserId,
                PropertyCardColoursEnum.Red,
                3
            ...
            var propertySetResponse = ResponseTestHelpers.CreatePropertySetResponse(
                actionContext,
                PropertyCardColoursEnum.Red
            );
        ...
        public void Tribute_EndToEnd_ChargesRentToAllPlayers()
        {
            ...
            var step2Result = this._dialogManager.RegisterActionResponse(
                initiator,
                propertySetResponse
            );
            ...
            var payResponse1 = ResponseTestHelpers.CreatePayValueResponse(
                step2Result.NewActionContexts[0],
                this._playerHandManager,
                target1.UserId,
                rentAmount
            );
        ...
        public void PirateRaid_EndToEnd_StealsProperty()
        {
            ...
            var target = GameStateTestHelpers.SetupPlayerInGame(
                this._playerManager,
                this._playerHandManager,
                "user2",
                "Target"
            ...
            var targetProperties = GameStateTestHelpers.GivePlayerPropertySet(
                this._playerHandManager,
                target.UserId,
            ...
            var playerSelectionResponse = ResponseTestHelpers.CreatePlayerSelectionResponse(
                actionContext,
                target.UserId
            );
            var step2Result = this._dialogManager.RegisterActionResponse(
            ...
            Assert.Equal(
                ...
                step2Result.NewActionContexts[0].DialogToOpen
            );

            // Act - Step 3: Select target property
            var propertySelectionResponse = ResponseTestHelpers.CreateTableHandResponse(
                step2Result.NewActionContexts[0],
                targetProperty.CardGuid.ToString()
            );
            var finalResult = this._dialogManager.RegisterActionResponse(
                initiator,
            ...
            var initiatorProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                initiator.UserId,
                PropertyCardColoursEnum.Green
            );
            var targetPropertiesAfter = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.Green
            );
        ...
        public void HostileTakeover_EndToEnd_StealsCompletePropertySet()
        {
            ...
            var targetProperties = GameStateTestHelpers.GivePlayerPropertySet(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.Yellow,
                3
            ); // Complete set
            var hostileTakeoverCard = CardTestHelpers.CreateCommandCard(
        ...
        public void BountyHunter_EndToEnd_CollectsDebtFromPlayer()
        {
            ...
            var payResponse = ResponseTestHelpers.CreatePayValueResponse(
                step2Result.NewActionContexts[0],
                this._playerHandManager,
                target.UserId,
                debtAmount
        ...
        public void ForcedTrade_EndToEnd_SwapsProperties()
        {
            ...
            var initiatorProperties = GameStateTestHelpers.GivePlayerPropertySet(
                this._playerHandManager,
                initiator.UserId,
                PropertyCardColoursEnum.Red,
                1
            ...
            var tradeResponse = ResponseTestHelpers.CreateTableHandResponse(
                step2Result.NewActionContexts[0],
                targetProperty.CardGuid.ToString()
            );
            ...
            var initiatorRedProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                initiator.UserId,
                PropertyCardColoursEnum.Red
            );
            var initiatorCyanProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                initiator.UserId,
                PropertyCardColoursEnum.Cyan
            );
            var targetRedProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.Red
            );
            var targetCyanProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.Cyan
            );
        ...
        public void TradeEmbargo_EndToEnd_DoublesRentCharge()
        {
            ...
            var ownHandResponse = ResponseTestHelpers.CreateOwnHandResponse(
                actionContext,
                rentCard.CardGuid.ToString()
            );
            var step2Result = this._dialogManager.RegisterActionResponse(
                initiator,
                ownHandResponse
            ...
            var step3Result = this._dialogManager.RegisterActionResponse(
                initiator,
                propertySetResponse
            );
            ...
            Assert.Equal(
                ...
                step3Result.NewActionContexts[0].DialogToOpen
            );

            // Act - Step 3: Player Selection
            var playerSelectionResponse = ResponseTestHelpers.CreatePlayerSelectionResponse(
                step3Result.NewActionContexts[0],
                target.UserId
            );
            var step4Result = this._dialogManager.RegisterActionResponse(
                initiator,
                playerSelectionResponse
            );
            ...
            var expectedBaseRent = this._rulesManager.CalculateRentAmount(
                PropertyCardColoursEnum.Red,
            ...
            var payResponse = ResponseTestHelpers.CreatePayValueResponse(
                step4Result.NewActionContexts[0],
                this._playerHandManager,
                target.UserId,
                doubledRent
            );
        ...
        public void PirateRaid_EndToEnd_StealsWildCardProperty()
        {
            ...
            var wildcardResponse = ResponseTestHelpers.CreateWildcardColorResponse(
                step3Result.NewActionContexts[0],
                PropertyCardColoursEnum.Cyan
            );
        ...
        public void ForcedTrade_EndToEnd_SwapsWildCardProperties()
        {
            ...
            var targetBrownProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.Brown
            );
        ...
        public void HostileTakeover_WithShieldsUpResponse_ActionBlocked()
        {
            ...
            GameStateTestHelpers.GivePlayerPropertySet(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.OmniSector,
                3
            );
            ...
            var shieldsUpResponse = ResponseTestHelpers.CreateShieldsUpResponse(
                step3Result.NewActionContexts[0]
            );
            ...
            var targetProperties = ResponseTestHelpers.GetPropertyGroupSafely(
                this._playerHandManager,
                target.UserId,
                PropertyCardColoursEnum.OmniSector
            );
            ...
            Assert.False(
                VerificationTestHelpers.PlayerHasCard(
                    this._playerHandManager,
                    target.UserId,
                    shieldsUpCard
                )
        ...
        public void PirateRaid_WithShieldsUpResponse_ActionBlocked()
        {
            ...
            var tableHandResponse = ResponseTestHelpers.CreateTableHandResponse(
                step2Result.NewActionContexts[0],
                targetProperties[0].CardGuid.ToString()
            );
            var step3Result = this._dialogManager.RegisterActionResponse(
                initiator,
                tableHandResponse
