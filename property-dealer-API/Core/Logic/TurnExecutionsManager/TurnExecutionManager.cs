...
namespace property_dealer_API.Core.Logic.TurnExecutionsManager
{
    public class TurnExecutionManager : ITurnExecutionManager
    {
        ...
        public TurnExecutionManager(IPlayerHandManager playerHandManager, IPlayerManager playerManager, IGameRuleManager rulesManager, IActionExecutionManager actionExecutionManager)
        {
        ...
        public ActionContext? ExecuteTurnAction(string userId, Card playerHandCard, CardDestinationEnum cardDestination, PropertyCardColoursEnum? colorDestination)
        {
